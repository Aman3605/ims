 ...
 *  with the help of the @RestController annotation. 
 *  This annotation is used at the class level and allows 
 *  the class to handle the requests made by the client.
 *  RestController generates and manages the REST data*/
/*
...
public class ProductRestController {
	...
	//Browse - http://localhost:8085/ims/api/products/47
  ...
  // @RequestBody annotation automatically deserializes the JSON into a Java type
   ...
   //In postman -DELETE - http://localhost:8085/ims/api/products/51
   ...
   //In postman -PUT - http://localhost:8085/ims/api/products/48
     // body -->raw -->Json -->enter Json object -->send
