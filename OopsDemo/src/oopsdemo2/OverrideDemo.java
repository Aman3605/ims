...
{
	int getRateofInterest() //ovverdien method
	{
		return 5;
	}
}
...
public class OverrideDemo {
	...
	public static void main(String[] args) {
        ...
        //invoke ovveridden method getRateofInterest() in SBI class
        System.out.println("The Interest Rate of SBI is :"+b1.getRateofInterest());
       
        b2.display();
        
      //invoke ovveridden method getRateofInterest() in ICICI class
        System.out.println("The Interest Rate of ICICI is :"+b2.getRateofInterest());
       
        b3.display();
        
      //invoke ovveridden method getRateofInterest() in AXIS class
